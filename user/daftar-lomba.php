                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive" style="overflow-x:hidden;">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="fotoid" class="form-control-label">Foto Identitas(ktm/sejenisnya), maks 1Mb </label>
                                                    <input type="file" id="fotoid" name="fotoid" class="form-control-file" required>
