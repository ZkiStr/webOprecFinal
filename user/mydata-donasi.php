...
<?php 
    ...
    include 'submit-3.php';

    //cek dulu sudah pernah submit belum
    $cekdulu = mysqli_query($conn,"select * from userdatadonasi where userid='$userid'");
    $ambil = mysqli_fetch_array($cekdulu);
    $status = $ambil['status'];
    
    //kalau udah pernah verify
    if($status=='Verified'){
        header("location:verified-3.php");
    } else {
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input name="namalengkap" type="text" class="form-control" placeholder="Nama Lengkap" maxlength="50" value="<?=$ambil['nama']?>" >
