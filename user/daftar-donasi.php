                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                         ...
                                         <br>2. Gunakan No.Whatsapp yang aktif untuk melakukan konfirmasi
                                         <br>3. Klik submit, kemudian klik Confirm. Setelah di-confirm, data tidak dapat diubah kembali.
                                         <br>4. Jika sudah, konfirmasi partisipan akan dikirim melalui No.Whatsapp
                                         <br>
