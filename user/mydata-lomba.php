...
<?php 
    ...
    if($status=='Verified'){
        header("location:verified-2.php");
    } else {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input name="whatsapp" type="number" class="form-control" placeholder="No Whatsapp" maxlength="15" value="<?=$ambil['whatsapp'] ?>" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" id="fotoid" name="fotoid" class="form-control-file" >
