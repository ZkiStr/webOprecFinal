                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="daftar.php"><i class="ti-layout"></i><span>Event</span></a>
                            </li>
                            <li>
                                <a href="#"><i class="ti-layout"></i><span>Competition</span></a>
                            </li>
                            <li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                         ...
                                         <br>
                                         <br>*Note: Pihak PARTI HIMATIF baru akan menerima data Anda setelah Anda klik 'Confirm'
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Data Pribadi*</h2>
                                    <p>*Data yang telah dikonfirmasi tidak dapat diubah kembali</p>
                                </div>
                                <div class="market-status-table mt-4">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input name="namalengkap" type="text" class="form-control" placeholder="Nama Lengkap" maxlength="50" value="<?=$ambil['namalengkap']?>" >
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <label>Email*</label>
                                                    <input name="email" type="email" class="form-control" placeholder="Email" maxlength="40" value="<?=$ambil['email']?>" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <img src="<?=$ambil['foto']?>" widht="30%">
                                                    <input type="hidden" value="<?=$userid;?>" name="id">
                                                    <input type="hidden" value="<?=$ambil['foto']?>" name="fotolama">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input name="whatsapp" type="number" class="form-control" placeholder="No Whatsapp" maxlength="15" value="<?=$ambil['whatsapp'] ?>" required>
                                                </div>
                                            </div>
                                        </div>
