    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact">CONTACT US</a>
                        <li class="nav-item"><a class="btn-secondary js-scroll-trigger" href="login.php"><span>LOGIN/REGISTER</span></a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <div class="masthead-subheading">OPEN RECRUITMENT HIMATIF UMS 
                    merupakan acara recruitment yang diselenggarakan oleh HIMATIF UMS untuk 
                    mencari bibit unggul yang siap berproses
                </div>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="login.php">JOIN NOW !</a>
            </div>
        </header>
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>PENDAFTARAN</h4>
                                    <h4 class="subheading">13 - 23 SEPTEMBER 2022</h4>
                                </div>
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    ...
                                    <h4 class="subheading">25 SEPTEMBER 2022</h4>
                                </div>
                                <div class="timeline-body"><p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p></div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    ...
                                    <h4 class="subheading">26 SEPTEMBER 2022</h4>
                                </div>
                                <div class="timeline-body"><p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p></div>
                            </div>
                        </li>
...
&& (isset($_POST['no_hp']) && !empty($_POST['no_hp']))
&& (isset($_POST['pesan']) && !empty($_POST['pesan']))){
//if((isset($_POST['name']) && (!empty($_POST['name']))) && (isset($_POST['email']) && !empty($_POST['email'])) && (isset($_POST['subject']) && !empty($_POST['subject']))){
	...
	$to = "l200200229@student.ums.ac.id";
	$headers = "From : " . $email;
	
	if( mail($to, $pesan, $headers)){
		echo "E-Mail Sent successfully, we will get back to you soon.";
		
		$query = "INSERT INTO save_contact(nama, email, no_hp, pesan) VALUES ('$nama', '$email', '$no_hp', '$pesan')";
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <form method="post" name="sentMessage">
                    ...
                    <div class="text-center">
                        <!--<div id="success">berhasil</div>-->
                        <input type="submit" class="btn btn-primary btn-xl text-uppercase" id="sendMessageButton" name="send-message" value="Send Message" />
                    </div>
                </form>
            </div>
        </section>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">BIDANG 2</h2>
                                    <p class="item-intro text-muted">KEMAHASISWAAN</p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">bidang 3</h2>
                                    <p class="item-intro text-muted">MINAT DAN BAKAT</p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">Bidang 4</h2>
                                    <p class="item-intro text-muted">KADERISASI</p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">bidang 5</h2>
                                    <p class="item-intro text-muted">SOSIAL DAN MASYARAKAT</p>
