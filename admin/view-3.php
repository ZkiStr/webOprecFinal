...
<head>
    ...
    <title>PARTI 2021 | Tampilkan Pendaftar</title>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="row mt-5 mb-5">
                    <div class="col-12">
                    <a href="form-3.php" class="btn btn-info" style="margin-bottom:2%;">Kembali</a>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    ...
                                    <img src="../user/<?php echo $ambil['foto']?>" width="30%">
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input name="whatsapp" type="number" class="form-control" placeholder="Whatsapp" maxlength="15" value="<?=$ambil['whatsapp']?>" disabled >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                        <a href="report-3.php?u=<?php echo $ambil['userid']?>" class="btn btn-primary">Download</a>
                                        </div>
