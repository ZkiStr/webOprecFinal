                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									...
									<table id="dataTable3" class="table table-hover" style="width:100%">
										...
										<tr>
											...
											<?php 
											$form=mysqli_query($conn,"SELECT * FROM userdatalomba where status='Verified' ORDER BY userdataid DESC");
											$no=1;
											...
											?>
												<tr>
                                                    ...
                                                    <td><a class="btn btn-primary btn-sm" href="view-2.php?u=<?php echo $b['userid'];?>">Lihat Detail</a></td>
												</tr>		
												<?php 
											}
											?>
								...
								<a href="exportform-2.php" target="_blank" class="btn btn-info">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
